...
int curse(int *chnum)
{
  ...
  while (1) {
	...
	printf("     Ch = %5d  Cnts = %10.0f  y = %10.0f  Energy = %.2f\n",
      ...
      /*mc An alternative, which does not truncate your cursor position reading to 
...
#undef W
      ...
      if (gf3gd.sharedyaxis == 1) goto SHRDSP;
      /*mc*/
    ...
    if (in2 >= 0) erase();  // OS lo hi -1 to NOT clear
